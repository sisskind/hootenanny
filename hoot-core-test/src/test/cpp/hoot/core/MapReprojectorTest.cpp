...
public:
  ...
  {
    boost::shared_ptr<OGRSpatialReference> sinusoidal = MapReprojector::createSinusoidalProjection(env);
    ...
    boost::shared_ptr<OGRSpatialReference> orthographic = MapReprojector::createOrthographic(env);
...
//    {
//      boost::shared_ptr<OGRSpatialReference> aeac = MapReprojector::createAeacProjection(env);
...
//    fs.close();
  ...
  void runCreatePlanarProjectionTest()
  {
...

    {
      ...
      boost::shared_ptr<OGRSpatialReference> srs = MapReprojector::getInstance().
...
//    }

    {
      ...
      env.MaxX = 180.0;
      env.MaxY = 89.5;
      boost::shared_ptr<OGRSpatialReference> srs = MapReprojector::createOrthographic(env);
