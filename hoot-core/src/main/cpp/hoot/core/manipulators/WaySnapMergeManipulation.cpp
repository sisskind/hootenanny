...
//double WaySnapMergeManipulation::_calculateExpertProbability(boost::shared_ptr<const OsmMap> map) const
//{
//  vector<long> wids;
...
//  boost::shared_ptr<Way> w1 = theMap->getWay(_left);
//  boost::shared_ptr<Way> w2 = theMap->getWay(_right);
