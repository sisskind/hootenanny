...
boost::shared_ptr<Geometry> ElementConverter::convertToGeometry(const boost::shared_ptr<const Way>& e, const bool statsFlag) const
{
...
boost::shared_ptr<Geometry> ElementConverter::convertToGeometry(const boost::shared_ptr<const Relation>& e, const bool statsFlag) const
{
  GeometryTypeId gid = getGeometryType(e, true, statsFlag);
