...
public:
   ...
   */
  boost::shared_ptr<geos::geom::Geometry> convertToGeometry(const boost::shared_ptr<const Element>& e, const bool statsFlag=false) const;
  ...
  boost::shared_ptr<geos::geom::Geometry> convertToGeometry(const boost::shared_ptr<const Way>& w, const bool statsFlag=false) const;
  boost::shared_ptr<geos::geom::Geometry> convertToGeometry(const boost::shared_ptr<const Relation>& r, const bool statsFlag=false) const;
